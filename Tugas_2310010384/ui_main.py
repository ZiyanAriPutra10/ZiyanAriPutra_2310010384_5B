...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        self.actionDATA_POLI = QAction(Main)
        self.actionDATA_POLI.setObjectName(u"actionDATA_POLI")
        self.actionDATA_OBAT = QAction(Main)
        self.actionDATA_OBAT.setObjectName(u"actionDATA_OBAT")
        self.actionDATA_REKAM_MEDIS = QAction(Main)
        self.actionDATA_REKAM_MEDIS.setObjectName(u"actionDATA_REKAM_MEDIS")
        ...
        self.menuHALAMAN_UTAMA.addAction(self.actionDATA_POLI)
        self.menuHALAMAN_UTAMA.addAction(self.actionDATA_OBAT)
    ...
    def retranslateUi(self, Main):
        ...
        self.actionDATA_POLI.setText(QCoreApplication.translate("Main", u"DATA POLI", None))
        self.actionDATA_OBAT.setText(QCoreApplication.translate("Main", u"DATA PEMERIKSAAN", None))
        self.actionDATA_REKAM_MEDIS.setText(QCoreApplication.translate("Main", u"DATA REKAM MEDIS", None))
