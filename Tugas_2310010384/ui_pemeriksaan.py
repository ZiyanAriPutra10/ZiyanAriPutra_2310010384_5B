...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QRect(80, 10, 281, 316))
        ...
        self.formLayout.setWidget(9, QFormLayout.ItemRole.SpanningRole, self.pemeriksaanTableWidget)
        ...
        self.formLayout.setWidget(7, QFormLayout.ItemRole.LabelRole, self.CariLabel)

        self.cetakButton = QPushButton(self.formLayoutWidget)
        self.cetakButton.setObjectName(u"cetakButton")

        self.formLayout.setWidget(10, QFormLayout.ItemRole.LabelRole, self.cetakButton)
