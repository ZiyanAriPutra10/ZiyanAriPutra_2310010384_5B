...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(10, QFormLayout.ItemRole.SpanningRole, self.pasienTableWidget)

        self.cariLineEdit = QLineEdit(self.formLayoutWidget)
        self.cariLineEdit.setObjectName(u"cariLineEdit")

        self.formLayout.setWidget(9, QFormLayout.ItemRole.SpanningRole, self.cariLineEdit)
